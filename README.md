🚀 LangChain Complete Guide – LLMs, Prompts, VectorStores, Chains & More
...
<br>
├── 3.EmbeddedModels/           → Embeddings (OpenAI, SentenceTransformers)
<br>
├── 4.Prompts/                  → PromptTemplate, ChatPromptTemplate
<br>
├── 5.langchain-structured-output/ → Pydantic, TypedDict output formatting
<br>
├── 6.langchain-output-parsers/ → StrOutputParser, JSONParser
<br>
├── 7.Chains/                   → SequentialChain, Runnable, LCEL
<br>
├── 8.Runnable/                 → RunnableSequence examples
<br>
├── 9.DocumentLoader/           → PDF/Text loaders
<br>
├── 10.TextSplitter/            → Chunking long documents
<br>
├── 11.VectorStore/             → FAISS Vector search
<br>
...
<br>
-Embeddings & why they are used
<br>
-Creating vector databases for semantic search
<br>
-Chunking documents with text splitters
<br>
-Designing professional prompts
<br>
